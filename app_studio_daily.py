...
# --- Layout ---
tab_snap, tab_sales, tab_chart, tab_visits, tab_forecast, tab_occupancy, tab_fw_dashboard, tab_sales_money = st.tabs(["Snap", "Sales", "Chart", "Visits", "Forecast", "Occupancy", "Summary", "Sales $"])
